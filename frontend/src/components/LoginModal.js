...
const LoginModal = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-white rounded-xl shadow-2xl w-full max-w-lg mx-auto relative"
        style={{
      ...
      >
        ...
        <div className="relative p-8 border-b border-gray-200">
          ...
          <h2 className="text-center text-2xl font-bold text-gray-900 mb-3 pr-10">
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="bg-emerald-50 p-5 rounded-lg border border-emerald-200">
            <h3 className="font-semibold text-emerald-800 mb-3 text-center flex items-center justify-center">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="bg-white px-4 text-gray-600 font-semibold text-sm">
                ODER
              </span>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
            <h3 className="font-semibold text-gray-800 mb-4 text-center flex items-center justify-center">
              <span className="mr-2">📧</span>
              Email & Passwort
            </h3>
