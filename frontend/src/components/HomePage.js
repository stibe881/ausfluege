        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/ausfluge">
              <Button 
                size="lg" 
                className="bg-white text-emerald-700 hover:bg-emerald-50 btn-hover font-semibold px-8 py-3 shadow-lg"
              >
            ...
            {isAuthenticated && (
              <Link to="/hinzufuegen">
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-white/80 text-white hover:bg-white/10 btn-hover font-semibold px-8 py-3 shadow-lg backdrop-blur-sm"
                >
